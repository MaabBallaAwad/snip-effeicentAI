...
def parse_arguments():
    ...
    # Data options
    parser.add_argument('--datasource', type=str, default='cifar-100-python', help='dataset to use')
    parser.add_argument('--path_data', type=str, default='./data', help='location to dataset')
    parser.add_argument('--aug_kinds', nargs='+', type=str, default=['fliplr', 'translate_px'],
                        help='augmentations to perform')

    # Model options
    parser.add_argument('--arch', type=str, default='vgg-like', help='network architecture to use')
    ...
    parser.add_argument('--train_iterations', type=int, default=30000, help='number of training iterations')
    parser.add_argument('--optimizer', type=str, default='momentum', help='optimizer of choice')
    parser.add_argument('--lr_decay_type', type=str, default='piecewise', help='learning rate decay type')
